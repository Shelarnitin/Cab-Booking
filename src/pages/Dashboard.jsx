  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          <h2 className="text-orange-600 text-lg font-semibold mb-2">Drivers</h2>
          <p className="text-gray-600 mb-4">View available drivers and their assigned trips.</p>
          <button onClick={() => navigate('/drivers')} className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg">Manage Drivers</button>
        </div>
      </div>
    </div>
  );
